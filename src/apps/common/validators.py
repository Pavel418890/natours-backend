from typing import TypeVar, Optional, Generic, Dict, NoReturn
...
def coordinates_validator(coordinates):
    ...
    lat, lng = coordinates
    if lat < -90.000000 or lat > 90.000000 \
            or lng < -180.000000 or lng > 180.000000:
...
class FieldsPairEqualityValidator:
    ...
    def __init__(
            self,
            fields: Generic[PairEqualityFields],
